...
void USB_OTG_BSP_Init(USB_STM32F407_HANDLE *pdev)
{
    UNUSED_PARAM(pdev);

  GPIO_InitTypeDef GPIO_InitStructure;

#ifndef STM32F407_USB_ULPI_PHY
 ...
 #else // STM32F407_USB_HS

  #ifdef STM32F407_USB_ULPI_PHY // ULPI
...
* @retval None
*/
void USB_OTG_BSP_EnableInterrupt(USB_STM32F407_HANDLE *pdev)
{
  NVIC_InitTypeDef NVIC_InitStructure;

  NVIC_PriorityGroupConfig(NVIC_PriorityGroup_1);
#ifdef STM32F407_USB_HS
