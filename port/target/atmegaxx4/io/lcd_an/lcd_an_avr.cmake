...
if (${CONFIG_LCD_PCF8574})
    setup_option_def(LCD_AN_AVR_I2C_ADDRESS 0x3F INT "I2C address for Alphanumeric LCD GPIO controller." CONFIG_FILE "lcd_an_avr_config")
    ...
    setup_option_def(LCD_AN_AVR_PIN_SCL PINB INT "SCL PIN register for I2C of Alphanumeric LCD GPIO controller." VALUE_FUN atmega_regmap VALUE_LIST atmega_pin_values CONFIG_FILE "lcd_an_avr_config")
    setup_option_def(LCD_AN_AVR_PIN_SDA PINB INT "SDA PIN register for I2C of Alphanumeric LCD GPIO controller." VALUE_FUN atmega_regmap VALUE_LIST atmega_pin_values CONFIG_FILE "lcd_an_avr_config")
    setup_option_def(LCD_AN_AVR_DDR_SCL DDRB INT "SCL DDR register for I2C of Alphanumeric LCD GPIO controller." VALUE_FUN atmega_regmap VALUE_LIST atmega_ddr_values CONFIG_FILE "lcd_an_avr_config")
    setup_option_def(LCD_AN_AVR_DDR_SDA DDRB INT "SDA DDR register for I2C of Alphanumeric LCD GPIO controller." VALUE_FUN atmega_regmap VALUE_LIST atmega_ddr_values CONFIG_FILE "lcd_an_avr_config")
    setup_option_def(LCD_AN_AVR_PORT_SCL PORTB INT "SCL PORT register for I2C of Alphanumeric LCD GPIO controller." VALUE_FUN atmega_regmap VALUE_LIST atmega_port_values CONFIG_FILE "lcd_an_avr_config")
    setup_option_def(LCD_AN_AVR_PORT_SDA PORTB INT "SDA PORT register for I2C of Alphanumeric LCD GPIO controller." VALUE_FUN atmega_regmap VALUE_LIST atmega_port_values CONFIG_FILE "lcd_an_avr_config")
    setup_option_def(LCD_AN_AVR_PIN_NUM_SCL 0 INT "SCL pin number for I2C of Alphanumeric LCD GPIO controller." VALUE_LIST atmega_pinnum_values CONFIG_FILE "lcd_an_avr_config")
    setup_option_def(LCD_AN_AVR_PIN_NUM_SDA 1 INT "SDA pin number for I2C of Alphanumeric LCD GPIO controller." VALUE_LIST atmega_pinnum_values CONFIG_FILE "lcd_an_avr_config")
else ()
