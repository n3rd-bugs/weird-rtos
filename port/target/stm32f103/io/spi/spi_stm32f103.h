...
#define STM32F103_SPI_SR_RXNE           (0x1)
#define STM32F103_SPI_SR_TXE            (0x2)
#define STM32F103_SPI_SR_CHSIDE         (0x4)
#define STM32F103_SPI_SR_UDR            (0x8)
#define STM32F103_SPI_SR_CRCERR         (0x10)
#define STM32F103_SPI_SR_MODF           (0x20)
#define STM32F103_SPI_SR_OVR            (0x40)
#define STM32F103_SPI_SR_BSY            (0x80)
