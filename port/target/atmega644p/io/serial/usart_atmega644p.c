...
static int32_t usart_atmega644p_puts(void *, void *, const uint8_t *, int32_t, uint32_t);
 ...
 */
static int32_t usart_atmega644p_puts(void *fd, void *priv_data, const uint8_t *buf, int32_t nbytes, uint32_t flags)
{
