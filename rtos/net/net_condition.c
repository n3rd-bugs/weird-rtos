...
void net_condition_init()
{
    ...
    task_create(&net_condition_tcb, P_STR("NET_CONDITION-CND"), net_condition_stack, NET_COND_STACK_SIZE, &net_condition_task_entry, (void *)(&net_condition_data), TASK_NO_RETURN);
