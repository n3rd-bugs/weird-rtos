...
/* Function prototypes. */
int32_t ppp_packet_protocol_parse(FS_BUFFER_LIST *, uint16_t *, uint8_t);
int32_t ppp_packet_protocol_add(FS_BUFFER_LIST *, uint16_t, uint8_t, uint8_t);
int32_t ppp_packet_configuration_header_parse(FS_BUFFER_LIST *, PPP_CONF_PKT *);
int32_t ppp_packet_configuration_option_parse(FS_BUFFER_LIST *, PPP_CONF_OPT *);
