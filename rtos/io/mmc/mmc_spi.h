...
#define MMC_SPI_CMD0            (0x0)
#define MMC_SPI_CMD1            (0x1)
#define MMC_SPI_CMD8            (0x8)
#define MMC_SPI_CMD9            (0x9)
#define MMC_SPI_CMD12           (0xC)
...
/* MMC command flags. */
#define MMC_SPI_CMD_SEL         (0x1)
#define MMC_SPI_CMD_UNSEL       (0x2)

/* MMC card type definitions. */
#define MMC_SPI_CARD_MMC        (0x1)
#define MMC_SPI_CARD_SD1        (0x2)
#define MMC_SPI_CARD_SD2        (0x4)
#define MMC_SPI_CARD_SD         ((MMC_SPI_CARD_SD1) | (MMC_SPI_CARD_SD2))
#define MMC_SPI_CARD_BLOCK      (0x8)
