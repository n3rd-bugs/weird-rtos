...
void USB_OTG_Switchback (USB_STM32F407_HANDLE *pdev);
uint32_t  USB_OTG_GetCurrentState (USB_STM32F407_HANDLE *pdev);

uint32_t STM32_USBO_OTG_ISR_Handler(USB_STM32F407_HANDLE *pdev);
/**
  * @}
  */ 
